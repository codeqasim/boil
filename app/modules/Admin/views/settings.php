...
<div class="panel panel-default">
    ...
    <form action="<?php echo base_url(ADMINURI); ?>settings" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                <img src="<?= base_url(FRONT_IMG_SETTING.$result["logo"])."?".Date('U') ?>" style="max-height: 60px;" class="pull-left hlogo_preview_img img-responsive brand-logos logo">
                </div>
            </div>
            <hr>
            <div class="form-group">
                ...
                <div class="col-md-4">
                <img style="max-height: 60px;" class="hlogo_preview_img img-responsive brand-logos favicon" src="<?= base_url(FRONT_IMG_SETTING.$result["favicon"])."?".Date('U')  ?>" >
            </div>
            </div>
            <hr>
            <div class="form-group">
