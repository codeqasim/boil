<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
            ...
            <li class="active"><a href="<?php echo base_url(ADMINURI); ?>accounts">Accounts</a></li>
            <li class="active"><a href="<?php echo base_url(ADMINURI); ?>accounts/types"><strong>Types</strong></a></li>
            </ol>
            </span>
            </div>
