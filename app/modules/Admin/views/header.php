...
<head>
    ...
    <meta name="theme-color" content="#0031bc"/>
    ...
    <link rel="stylesheet" href="<?php echo base_url(ASSETS); ?>lib/multi_select/multiple-select.css"/>
    ...
    <script>
        ...
        !function (a, b) {
            ...
            var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString,
                j = h.hasOwnProperty, k = {}, l = "1.11.2", m = function (a, b) {
            ...
            var s = function (a) {
                var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + 1 * new Date,
                    v = a.document, w = 0, x = 0, y = hb(), z = hb(), A = hb(), B = function (a, b) {
                        return a === b && (l = !0), 0
            ...
            var eb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
                ...
                kb = /<tbody/i, lb = /<|&#?\w+;/, mb = /<(?:script|style|link)/i,
                nb = /checked\s*(?:[^=]|=\s*.checked.)/i, ob = /^$|\/(?:java|ecma)script/i, pb = /^true\/(.*)/,
                qb = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, rb = {
    ...
    <!-- datepicker -->
    <link href="<?php echo base_url(); ?>assets/lib/datepicker/jquery-ui.css" rel="stylesheet">
    <script src="<?php echo base_url(); ?>assets/lib/datepicker/jquery-ui.js"></script>
...
<body id="replace">
<div class="be-wrapper be-collapsible-sidebar <?=!empty($drawer_status)? 'be-collapsible-sidebar-collapsed' : '' ?> ">

    <nav id="nav_admin"  class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="<?php echo base_url(ADMINURI); ?>dashboard" class="navbar-brands" style="position: absolute; padding: 22px;">Backend Console</a>
            ...
            <div class="be-right-navbar">
                <ul class="nav navbar-nav navbar-right be-user-nav">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                            ...
                            <img src="<?php echo base_url(); ?>assets/img/favicon.png" alt="Avatar"><span
                        ...
                        <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url(ADMINURI); ?>profile"><span class="icon mdi mdi-face"></span> profile</a></li>
                            <!--<li><a href="#"><span class="icon mdi mdi-settings"></span> Settings</a></li>-->
                            <li><a href="<?php echo base_url(ADMINURI); ?>logout"><span class="icon mdi mdi-power"></span> Logout</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="be-left-sidebar">
        <div class="left-sidebar-wrapper"><a href="<?= base_url(ADMINURI); ?>dashboard" class="left-sidebar-toggle">Dashboard</a>
            <div class="left-sidebar-spacer">
                <div class="left-sidebar-scroll">
                    <div class="left-sidebar-content">
                        <ul class="sidebar-elements">
                            <li class="divider">Menu</li>
                            <li class="<?=add_active("dashboard")?>"><a href="<?= base_url(ADMINURI); ?>dashboard"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a></li>
                            ...
                            <li class="<?=add_active("accounts")?>"><a href="javascript:void(0)"><i class="icon mdi mdi-face"></i><span>Accounts</span></a>
                                <ul class="sub-menu">
                                    <li><a href="<?= base_url(ADMINURI); ?>accounts">Accounts</a></li>
                                    <li><a href="<?= base_url(ADMINURI); ?>accounts/types">Types</a></li>
                                    <li class="divider"></li>
                                    <?php foreach ($accounts_types as $act) { ?>
                                    <li><a href="<?= base_url(ADMINURI."accounts/".slugify($act->type)); ?>"><?=$act->type?></a></li>
                                    <?php }?>
                                </ul>
                            </li>
                            ...
                            <li class="<?=add_active("blogs")?>"><a href="javascript:void(0)"><i class="icon mdi mdi-border-all"></i><span>Blogs</span></a>
                                <ul class="sub-menu">
                                    <li><a href="<?php echo base_url(ADMINURI); ?>blogs"><!--<span class="label label-primary pull-right">New</span>-->Blogs</a></li>
                                    <li><a href="<?php echo base_url(ADMINURI); ?>blogs/categories">Blogs Categories</a></li>
                                </ul>
                            </li>
                            <?php } ?>
                            <li class="<?=add_active("pages")?>"><a href="javascript:void(0)"><i class="icon mdi mdi-layers"></i><span>Pages</span></a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="pages-code-editor.html"><span class="label label-primary pull-right">New    </span>Code
                                            Editor</a>
                                    </li>
                                    <li><a href="pages-booking.html"><span
                                                    class="label label-primary pull-right">New</span>Booking</a>
                                    </li>
                                    <li><a href="pages-loaders.html"><span
                                                    class="label label-primary pull-right">New</span>Loaders</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="divider">Features</li>
                            <li class="<?=add_active("email")?>"><a href="#"><i class="icon mdi mdi-inbox"></i><span>Email</span></a>
                                <ul class="sub-menu">
                                    <li><a href="email-inbox.html">Inbox</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="<?=add_active("layouts")?>"><a href="#"><i class="icon mdi mdi-view-web"></i><span>Layouts</span></a>
                                <ul class="sub-menu">
                                    <li><a href="layouts-primary-header.html">Primary Header</a>
                                    </li>
                                    <li><a href="layouts-sub-navigation.html"><span
                                                    class="label label-primary pull-right">New</span>Sub Navigation</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="parent"><a href="#"><i
                                            class="icon mdi mdi-folder"></i><span>Menu Levels</span></a>
                                <ul class="sub-menu">
                                    <li class="parent"><a href="#"><i
                            ...
                            <li class=""><a href="<?= base_url(ADMINURI); ?>subscribers"><i
                                            class="icon mdi mdi-home"></i><span>Subscribers</span></a></li>
                            </li>
                        </ul>
                    </div>
                </div>
