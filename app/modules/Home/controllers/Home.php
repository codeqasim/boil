...
class Home extends MX_Controller {
    ...
    public function index() { $this->theme->view('modules/bnb/index'); }
    public function contact() { $this->theme->view('contact'); }
    public function listing() { $this->theme->view('modules/bnb/listing'); }

    public function error(){ $this->output->set_status_header('404'); $data['metas'] = error_meta(); $this->theme->view('404', $data); }
